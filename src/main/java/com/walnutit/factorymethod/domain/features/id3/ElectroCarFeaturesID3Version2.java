 ...
 */
package com.walnutit.factorymethod.domain.features.id3;
 ...
 *
 */
public class ElectroCarFeaturesID3Version2
		extends ElectroCarFeatures {

	public static ElectroCarFeaturesID3Version2 getElectroCarFEaturesID3Version2(
			Engine engine, Color color,
			BatteryCapacity batteryCapacity, Rim rim,
			ExtraEquipment extraEquipment) {
		return new ElectroCarFeaturesID3Version2(engine, color,
	 ...
	 */
	private ElectroCarFeaturesID3Version2(Engine engine, Color color,
			BatteryCapacity batteryCapacity, Rim rim,
			ExtraEquipment extraEquipment) {
